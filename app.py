...
# Configuração correta do diretório
...
# --- LISTA BLINDADA (Texto Único) ---
# Usamos uma string gigante para evitar erros de esquecer vírgulas ou aspas.
# O código abaixo converte isso automaticamente para a lista que precisamos.
RAW_BANCAS = """
...
avancar, bios, inovaty, fenix, facto, hl, gama, decorp, cl, maxima, arespci, 
intelectus, abare, univasf, itco
"""

# Processa a string para criar a lista limpa
